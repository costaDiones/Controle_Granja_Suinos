...
public class Funcionario_Edicao extends JFrame {
	...
	private JLabel jlbInfGranja = new JLabel("Editar Funcionario");
	private JButton jbtCadastrarFuncionario = new JButton("Editar"),
	...
	public void setValor(Integer posicao){
		jtfNomeFunci.setText(funcionarioDao.listarTodos().get(posicao).getNome());
		jtfSalarioFunci.setText(funcionarioDao.listarTodos().get(posicao).getSalario().toString());
	...
	public Funcionario_Edicao( final DefaultTableModel dtmDados) {
		setLayout(null);
		...
		jbtCadastrarFuncionario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(jtfNomeFunci.getText().isEmpty()||jtfSalarioFunci.getText().isEmpty()){
					...
					funcionario=funcionarioDao.listarTodos().get(Integer.valueOf(jtfGuardaValor.getText()));
