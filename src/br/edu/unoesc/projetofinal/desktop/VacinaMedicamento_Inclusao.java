...
public class VacinaMedicamento_Inclusao extends JFrame {

	private JLabel jlbVaciMedi = new JLabel("Vacina Medicamento");
	...
	public VacinaMedicamento_Inclusao(final DefaultTableModel dtDados) {
		setLayout(null);
		...
		jbtCadastrarFornCli.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (jtfVacinaVaciMedi.getText().isEmpty()) {
					JOptionPane.showMessageDialog(null, "Digite o nome do Cliente/Fornecedor!");
				} else {
					int aux = 0;
