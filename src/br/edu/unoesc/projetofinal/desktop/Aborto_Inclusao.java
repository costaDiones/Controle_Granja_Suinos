...
public class Aborto_Inclusao extends JFrame{
	...
	public Aborto_Inclusao(final DefaultTableModel dtmDados){
		setLayout(null);
		...
		jbtCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(jtfData.getText().isEmpty()||jtfObservacao.getText().isEmpty()){
					...
					abortoDao.store(aborto);
					JOptionPane.showMessageDialog(null, "Aborto Cadastrado com Sucesso");
