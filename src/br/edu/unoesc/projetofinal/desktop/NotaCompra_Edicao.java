...
public class NotaCompra_Edicao extends JFrame {
	...
	public void setValor(Integer posicao){
		...
		for(Fornecedor fornecedor:fornecedorDAO.listarTodos()){
			if(fornecedor.getNome().equals(notaDao.listarTodos().get(posicao).getFornecedor().getNome())){
	...
	public NotaCompra_Edicao(final DefaultTableModel dtmDados) {
		setLayout(null);
