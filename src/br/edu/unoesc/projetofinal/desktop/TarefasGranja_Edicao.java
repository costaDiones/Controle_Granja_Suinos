...
public class TarefasGranja_Edicao extends JFrame {

	private JLabel jlbForneCli = new JLabel("Editar Tarefa da Granja");
	...
	public void setValor(Integer posicao){
		jtfDataTarefa.setText(tarefaDao.listarTodos().get(posicao).getDataTarefa().toString());
		jtfDescricao.setText(tarefaDao.listarTodos().get(posicao).getDescricao());
		jtfGuardaValor.setText(posicao.toString());
	}
	
	TarefasGranja_Edicao(final DefaultTableModel dtmDados) {
		setLayout(null);
